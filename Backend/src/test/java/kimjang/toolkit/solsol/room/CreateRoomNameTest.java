...
//        UserDto customer = new UserDto(2L, "solsol@naver.com","조승효");
...
//        CreateChatRoomDto createChatRoomDto = new CreateChatRoomDto(
//                Arrays.asList(new UserDto(1L ,"solsol@naver.com","오찬솔"), new UserDto(2L,"solsol@naver.com", "조승효"), new UserDto(3L, "solsol@naver.com","강아지")),
//                 "", "효승이 자니??", new UserDto(2L,"solsol@naver.com", "조승효"));
//        UserDto customer = new UserDto(2L,"solsol@naver.com","조승효");
//        String result = CreateRoomName.withParticipationsName(createChatRoomDto, customer.getId());
...
//        CreateChatRoomDto createChatRoomDto = new CreateChatRoomDto(
//                Arrays.asList(new UserDto(1L ,"solsol@naver.com","오찬솔"), new UserDto(2L,"solsol@naver.com", "조승효"), new UserDto(3L,"solsol@naver.com", "강아지")),
//                "아무거나 방", "효승이 자니??", new UserDto(2L, "solsol@naver.com","조승효"));
//        UserDto customer = new UserDto(2L, "solsol@naver.com","조승효");
//        String result = CreateRoomName.withParticipationsName(createChatRoomDto, customer.getId());
