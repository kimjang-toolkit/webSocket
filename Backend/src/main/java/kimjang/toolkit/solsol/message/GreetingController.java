...
public class GreetingController {
	...
	public ResponseEntity<Greeting> greeting(HelloMessage message) throws Exception { // HelloMessage 객체가 인자로 들어가게된다.
		Thread.sleep(1000); // simulated delay
		System.out.println("message : "+message.getName());
//		return new Greeting("Hello, " + HtmlUtils.htmlEscape(message.getName()) + "!");
		return ResponseEntity.ok(new Greeting("Hello, "+message.getName()+"!"));
	}
